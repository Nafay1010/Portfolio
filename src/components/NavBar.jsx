        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#experience" className={activeLink === 'experience' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('experience')}>Languages</Nav.Link>
            ...
            <span className="navbar-text">
              <div className="social-icon">
                ...
                <button className="contactbtn" onClick={openModal}>CV</button>
            </span>
          </Navbar.Collapse>
        </Container>
      </Navbar>
